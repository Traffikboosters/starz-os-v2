          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-card border-border/50 focus:border-cyan/50 focus:ring-cyan/20"
                required
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="bg-card border-border/50 focus:border-cyan/50 focus:ring-cyan/20 pr-10"
                  required
                />
                <button
                  type="button"
